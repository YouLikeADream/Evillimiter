...
Check out the open-source alternative [EvilLimiter for Windows](https://github.com/YouLikeADream/evillimiter-windows).
...
```bash
git clone https://github.com/YouLikeADream/evillimiter.git
cd evillimiter
sudo python3 setup.py install
```

Alternatively, you can download a desired version from the [Release page](https://github.com/YouLikeADream/evillimiter/releases).<br>
